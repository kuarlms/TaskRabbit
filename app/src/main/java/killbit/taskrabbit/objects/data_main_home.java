...
public class data_main_home {
    ...
    public data_main_home(String cat_name, String cat_title, String cat_icon, String cat_id,data_sub_home sub_data) {
    ...
    public data_sub_home getSub_data() {
        return sub_data;
    }

    public void setSub_data(data_sub_home sub_data) {
        this.sub_data = sub_data;
    }
}
