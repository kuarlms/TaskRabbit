package taskrabit.x33.com.tasker.fragments;
...
public class cancelled extends Fragment implements taskHistory_canceled_adapter.OnTaskDoneListner {
    ...
    taskHistory_canceled_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.taskshistory_cancelled, container, false);
        ...
        adapter = new taskHistory_canceled_adapter(tasks_datas,getActivity(),this);
    ...
    public void onStart() {
        super.onStart();
      /*  mAPIService.rf_dashboard_user_task_history_Cancelled(ApiInterface.header_value, sp.getString(sp_task.Sp_email,"")).enqueue(new Callback<ActiveTaskResp>() {
            @Override
