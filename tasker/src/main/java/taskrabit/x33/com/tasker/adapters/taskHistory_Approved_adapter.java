package taskrabit.x33.com.tasker.adapters;
...
public class taskHistory_Approved_adapter extends RecyclerView.Adapter<taskHistory_Approved_adapter.MyViewHolder> {
...
//TextView tv;
    ...
    public taskHistory_Approved_adapter(List<active_tasks_data> taskList, Context context, OnTaskDoneListner taskDoneListner) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adap_task_history_approved, parent, false);
