...
public class taskHistory_Pending_adapter extends RecyclerView.Adapter<taskHistory_Pending_adapter.MyViewHolder> {
...
//TextView tv;
    ...
    public taskHistory_Pending_adapter(List<active_tasks_data> taskList, Context context, OnTaskDoneListner taskDoneListner) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adap_task_history_pending, parent, false);
